...
function Ur(s, t) {
  ...
  return xr(s, t.pts[0]) ? true : Fn(t, s.center);
}
...
var De = class {
  ...
  numListeners(t) {
    var _a;
    return ((_a = this.handlers[t]) == null ? void 0 : _a.numListeners()) ?? 0;
  }
};
o(De, "EventHandler");
function Bn(s, t) {
...
var Or = o((s) => {
  ...
  function le(d) {
    ...
    let b = 0, C = o((ee) => {
      ...
      t.realTime = re, b += V, b > Oe && (t.skipTime || (t.dt = b, t.time += g(), t.fpsCounter.tick(t.dt)), b = 0, t.skipTime = false, t.numFrames++, Dt(), d(), pn()), t.loopID = requestAnimationFrame(C);
    }, "frame");
    C(0);
  }
  o(le, "run");
  ...
  function ft() {
    ...
    for (let d of t.gamepads) {
      let b = navigator.getGamepads()[d.index], ee = (s.gamepads ?? {})[b.id] ?? jn[b.id] ?? jn.default, re = t.gamepadStates.get(d.index);
  ...
  de.keydown = (d) => {
    ...
    Gt(d.gamepad), t.events.onOnce("input", () => {
...
var mo = o((s = {}) => {
  ...
  })(), g = s.scale ?? 1, E = s.width && s.height && !s.stretch && !s.letterbox;
  ...
  o(Ge, "FrameBuffer");
  let w = (() => {
    let e = ft(kn, _n), n = K.fromImage(new ImageData(new Uint8ClampedArray([255, 255, 255, 255]), 1, 1)), r = s.width && s.height ? new Ge(s.width * I, s.height * I) : new Ge(h.drawingBufferWidth / g, h.drawingBufferHeight / g), i = null, u = 1;
    s.background && (i = L.fromArray(s.background), u = s.background[3] ?? 1, h.clearColor(i.r / 255, i.g / 255, i.b / 255, u)), h.enable(h.BLEND), h.enable(h.SCISSOR_TEST), h.blendFuncSeparate(h.SRC_ALPHA, h.ONE_MINUS_SRC_ALPHA, h.ONE, h.ONE_MINUS_SRC_ALPHA);
  ...
  class le {
    ...
    static fromImage(n, r = {}) {
      let [i, u] = B.packer.add(n), l = r.frames ? r.frames.map((a) => new Q(u.x + a.x * u.w, u.y + a.y * u.h, a.w * u.w, a.h * u.h)) : Et(r.sliceX || 1, r.sliceY || 1, u.x, u.y, u.w, u.h);
  ...
  class ge {
    ...
    static fromURL(n) {
      return Vn(n) ? ge.fromArrayBuffer(Sr(n)) : nn(n).then((r) => ge.fromArrayBuffer(r));
    }
  }
  o(ge, "SoundData");
  let he = (() => {
  ...
  class xe {
    ...
    add(n, r) {
      let i = n ?? this.lastUID++ + "", u = new ie(r);
      return this.assets.set(i, u), u;
    }
    addLoaded(n, r) {
      let i = n ?? this.lastUID++ + "", u = ie.loaded(r);
      return this.assets.set(i, u), u;
    }
    get(n) {
  ...
  o(xe, "AssetBucket");
  let B = { urlPrefix: "", sprites: new xe(), fonts: new xe(), bitmapFonts: new xe(), sounds: new xe(), shaders: new xe(), custom: new xe(), packer: new pe(kr, _r), loaded: false }, T = { events: new De(), objEvents: new De(), root: Qn([]), gravity: 0, scenes: {}, logs: [], cam: { pos: null, scale: new v(1), angle: 0, shake: 0, transform: new J() } };
  function ct(e) {
  ...
  function Je(e) {
    let n = new Image();
    return n.crossOrigin = "anonymous", n.src = Vn(e) ? e : B.urlPrefix + e, new Promise((r, i) => {
  ...
  class _e {
    constructor(n, r = {}) {
      ...
      this.fontface = n, this.outline = r.outline ?? 0, this.filter = r.filter ?? qr;
    }
  }
  o(_e, "FontData");
  function sn(e, n, r = {}) {
  ...
  function on(e, n, r, i, u = {}) {
    return B.bitmapFonts.add(e, Je(n).then((l) => de(K.fromImage(l, u), r, i, u.chars ?? Br)));
  }
  o(on, "loadBitmapFont");
  ...
  function St(e, n) {
    return ct(typeof n == "string" ? new Promise((r, i) => {
      ...
      let i = {};
      for (let u in n) {
        let l = n[u], a = r.frames[0], m = kr * a.w, f = _r * a.h, p = l.frames ? l.frames.map((D) => new Q(a.x + (l.x + D.x) / m * a.w, a.y + (l.y + D.y) / f * a.h, D.w / m * a.w, D.h / f * a.h)) : Et(l.sliceX || 1, l.sliceY || 1, a.x + l.x / m * a.w, a.y + l.y / f * a.h, l.width / m * a.w, l.height / f * a.h), x = new le(r.tex, p, l.anims);
  ...
  function He(e, n, r = { sliceX: 1, sliceY: 1, anims: {} }) {
    return Array.isArray(n) ? n.some((i) => typeof i == "string") ? B.sprites.add(e, Promise.all(n.map((i) => typeof i == "string" ? Je(i) : Promise.resolve(i))).then((i) => Ct(i, r))) : B.sprites.addLoaded(e, Ct(n, r)) : typeof n == "string" ? B.sprites.add(e, le.from(n, r)) : B.sprites.addLoaded(e, le.fromImage(n, r));
  }
  o(He, "loadSprite");
  function an(e, n) {
    return B.sprites.add(e, new Promise(async (r) => {
      let i = typeof n == "string" ? await We(n) : n, u = await Promise.all(i.frames.map(Je)), l = document.createElement("canvas");
  ...
  o(pn, "volume");
  function dt(e, n = {}) {
    let r = he.ctx, i = n.paused ?? false, u = r.createBufferSource(), l = new ve(), a = r.createGain(), m = n.seek ?? 0, f = 0, p = 0, x = false;
    u.loop = !!n.loop, u.detune.value = n.detune ?? 0, u.playbackRate.value = n.speed ?? 1, u.connect(a), u.onended = () => {
      var _a;
      j() >= ((_a = u.buffer) == null ? void 0 : _a.duration) && l.trigger();
    }, a.connect(he.masterNode), a.gain.value = n.volume ?? 1;
    let D = o((O) => {
    ...
    return { set paused(O) {
      ...
      var _a;
      ((_a = u.buffer) == null ? void 0 : _a.duration) && (O > u.buffer.duration || (i ? (u = $(u), f = p - O) : (u.stop(), u = $(u), f = r.currentTime - O, u.start(0, O), x = true, p = 0)));
    }, set speed(O) {
      ...
      var _a;
      return ((_a = u.buffer) == null ? void 0 : _a.duration) ?? 0;
    }, time() {
  ...
  function ft(e = kn, n = _n) {
    let r = Mi.replace("{{user}}", e ?? kn), i = Di.replace("{{user}}", n ?? _n), u = h.createShader(h.VERTEX_SHADER), l = h.createShader(h.FRAGMENT_SHADER);
    ...
    if (X.push(() => h.deleteProgram(a)), h.attachShader(a, u), h.attachShader(a, l), h.bindAttribLocation(a, 0, "a_pos"), h.bindAttribLocation(a, 1, "a_uv"), h.bindAttribLocation(a, 2, "a_color"), h.linkProgram(a), !h.getProgramParameter(a, h.LINK_STATUS)) {
      let m = o((D) => {
        let q = /^ERROR:\s0:(?<line>\d+):\s(?<msg>.+)/, j = D.match(q);
  ...
  function Be(e, n, r, i = w.defTex, u = w.defShader, l = {}) {
    ...
    if (!a || a instanceof ie)
      return;
    (i !== w.curTex || a !== w.curShader || !Bn(w.curUniform, l) || w.vqueue.length + e.length * Zt > $r || w.iqueue.length + n.length > zr) && fe();
  ...
  function Oe(e) {
    ...
    if (e.width <= 0 || e.height <= 0)
      return;
    let n = e.width, r = e.height, u = ut(e.anchor || Jt).scale(new v(n, r).scale(-0.5)), l = e.quad || new Q(0, 0, 1, 1), a = e.color || W(255, 255, 255), m = e.opacity ?? 1, f = e.tex ? Hr / e.tex.width : 0, p = e.tex ? Hr / e.tex.height : 0, x = l.x + f, D = l.y + p, q = l.w - f * 2, j = l.h - p * 2;
  ...
  function Ie(e) {
    ...
    let n = e.quad ?? new Q(0, 0, 1, 1), r = e.tex.width * n.w, i = e.tex.height * n.h, u = new v(1);
    if (e.tiled) {
  ...
  function Xr(e) {
    ...
    Ie(Object.assign({}, e, { tex: n.data.tex, quad: r.scale(e.quad ?? new Q(0, 0, 1, 1)) }));
  }
  o(Xr, "drawSprite");
  ...
  function Ce(e) {
    ...
    if (e.radius) {
      ...
      l = [new v(a, 0), new v(n - a, 0), ...mt(new v(n - a, a), a, a, 270, 360), new v(n, a), new v(n, r - a), ...mt(new v(n - a, r - a), a, a, 0, 90), new v(n - a, r), new v(a, r), ...mt(new v(a, r - a), a, a, 90, 180), new v(0, r - a), new v(0, a), ...mt(new v(a, a), a, a, 180, 270)];
    }
    qe(Object.assign({}, e, { offset: u, pts: l, ...e.gradient ? { colors: e.horizontal ? [e.gradient[0], e.gradient[1], e.gradient[1], e.gradient[0]] : [e.gradient[0], e.gradient[0], e.gradient[1], e.gradient[1]] } : {} }));
  }
  o(Ce, "drawRect");
  function pt(e) {
    let { p1: n, p2: r } = e;
    ...
    let i = e.width || 1, u = r.sub(n).unit().normal().scale(i * 0.5), l = [n.sub(u), n.add(u), r.add(u), r.sub(u)].map((a) => ({ pos: new v(a.x, a.y), uv: new v(0), color: e.color ?? L.WHITE, opacity: e.opacity ?? 1 }));
    ...
    if (!(n.length < 2))
      if (e.radius && n.length >= 3) {
        ...
        for (let r = 0; r < n.length - 1; r++)
          pt(Object.assign({}, e, { p1: n[r], p2: n[r + 1] })), e.join !== "none" && Qe(Object.assign({}, e, { pos: n[r], radius: e.width / 2 }));
  }
  o(Hn, "drawLines");
  function qn(e) {
    if (!e.p1 || !e.p2 || !e.p3)
  ...
  function $n(e) {
    ...
    if (e.radiusX === 0 || e.radiusY === 0)
      return;
    let n = e.start ?? 0, r = e.end ?? 360, i = ut(e.anchor ?? "center").scale(new v(-e.radiusX, -e.radiusY)), u = mt(i, e.radiusX, e.radiusY, n, r, e.resolution);
    u.unshift(i);
  ...
  function qe(e) {
    ...
    if (!(n < 3)) {
      if (re(), b(e.pos), C(e.scale), ee(e.angle), b(e.offset), e.fill !== false) {
        let r = e.color ?? L.WHITE, i = e.pts.map((l, a) => ({ pos: new v(l.x, l.y), uv: new v(0, 0), color: e.colors ? e.colors[a] ?? r : r, opacity: e.opacity ?? 1 })), u = [...Array(n - 2).keys()].map((l) => [0, l + 1, l + 2]).flat();
        Be(i, e.indices ?? u, e.fixed, w.defTex, e.shader, e.uniform);
      }
      e.outline && Hn({ pts: [...e.pts, e.pts[0]], radius: e.radius, width: e.outline.width, color: e.outline.color, join: e.outline.join, uniform: e.uniform, fixed: e.fixed, opacity: e.opacity }), V();
    }
  }
  o(qe, "drawPolygon");
  function zn(e, n, r) {
  ...
  function $e(e) {
    ...
    if (n instanceof _e || typeof n == "string") {
      let _ = n instanceof _e ? n.fontface.family : n, H = n instanceof _e ? { outline: n.outline, filter: n.filter } : { outline: 0, filter: qr }, F = wn[_] ?? { font: { tex: new K(jr, Nr, { filter: H.filter }), map: {}, size: Ir }, cursor: new v(0), outline: H.outline };
    ...
    let l = e.size || n.size, a = S(e.scale ?? 1).scale(l / n.size), m = e.lineSpacing ?? 0, f = e.letterSpacing ?? 0, p = 0, x = 0, D = 0, q = [], j = [], $ = 0, O = null, A = null;
    for (; $ < u.length; ) {
      let _ = u[$];
      if (_ === `
`)
  ...
  o(Wn, "drawText");
  function ze(e) {
    re(), b(e.opt.pos), ee(e.opt.angle), b(ut(e.opt.anchor ?? "topleft").add(1, 1).scale(e.width, e.height).scale(-0.5)), e.chars.forEach((n) => {
  ...
  function Qn(e) {
    let n = /* @__PURE__ */ new Map(), r = {}, i = new De(), u = null, l = { id: Ar(), hidden: false, paused: false, transform: new J(), children: [], parent: null, add(a) {
      ...
      return m.parent = this, m.transform = Vt(m), this.children.push(m), m.trigger("add", m), T.events.trigger("add", m), m;
    }, readd(a) {
      ...
      this.hidden || (re(), b(this.pos), C(this.scale), ee(this.angle), this.trigger("draw"), this.children.sort((a, m) => (a.z ?? 0) - (m.z ?? 0)).forEach((a) => a.draw()), V());
    }, drawInspect() {
      this.hidden || (re(), b(this.pos), C(this.scale), ee(this.angle), this.children.sort((a, m) => (a.z ?? 0) - (m.z ?? 0)).forEach((a) => a.drawInspect()), this.trigger("drawInspect"), V());
    }, use(a) {
      if (!a)
        return;
      if (typeof a == "string")
  ...
  o(xs, "z");
  function Us(e, n) {
    return { id: "follow", require: ["pos"], follow: { obj: e, offset: n ?? S(0) }, add() {
  ...
  function Ts(e = {}) {
    ...
    return { id: "area", collisionIgnore: e.collisionIgnore ?? [], add() {
      ...
      let u = { outline: { width: 4 / Kn(), color: W(0, 0, 255) }, anchor: this.anchor, fill: false, fixed: this.fixed };
      i instanceof ne ? Ce({ ...u, pos: i.pos, width: i.width, height: i.height }) : i instanceof Pe ? qe({ ...u, pts: i.pts }) : i instanceof ke && Qe({ ...u, pos: i.center, radius: i.radius }), V();
    }, area: { shape: e.shape ?? null, scale: e.scale ? S(e.scale) : S(1), offset: e.offset ?? S(0), cursor: e.cursor ?? null }, isClicked() {
      ...
      let u = this.transform.clone().scale(S(this.area.scale ?? 1)).translate(this.area.offset);
      if (i instanceof ne) {
  ...
  function As(e, n = {}) {
    function r(i) {
      ...
      return n.width || (i.width = u.width / (((_a = i.scale) == null ? void 0 : _a.x) || 1)), i.height = u.height / (((_b = i.scale) == null ? void 0 : _b.y) || 1), u;
    }
  ...
  function Fs(e = {}) {
    ...
    return { id: "body", require: ["pos", "area"], jumpForce: e.jumpForce ?? Ds, gravityScale: e.gravityScale ?? 1, isStatic: e.isStatic ?? false, mass: e.mass ?? 1, add() {
      ...
      this.onCollideUpdate((l, a) => {
        if (l.is("body") && !a.resolved && (this.trigger("beforePhysicsResolve", a), l.trigger("beforePhysicsResolve", a.reverse()), !a.resolved && !(this.isStatic && l.isStatic))) {
          if (!this.isStatic && !l.isStatic) {
            ...
            this.pos = this.pos.add(a.displacement.scale(l.mass / m)), l.pos = l.pos.add(a.displacement.scale(-this.mass / m)), this.transform = Vt(this), l.transform = Vt(l);
          } else {
            let m = !this.isStatic && l.isStatic ? a : a.reverse();
            m.source.pos = m.source.pos.add(m.displacement), m.source.transform = Vt(m.source);
          }
      ...
      let l = n.y;
      n.y += T.gravity * this.gravityScale * Te(), n.y = Math.min(n.y, e.maxVelocity ?? Gs), l < 0 && n.y >= 0 && this.trigger("fall"), this.move(n);
    }, onPhysicsResolve(l) {
  ...
  function js(e, n = {}) {
    ...
    return { id: "lifespan", async add() {
      await gt(e), r > 0 && this.opacity && await Cn(this.opacity, 0, r, (i) => this.opacity = i, ot.linear), this.destroy();
    } };
  }
  o(js, "lifespan");
  function Ns(e, n, r) {
  ...
  function or(e = {}) {
    let n = S(0), r = e.isObstacle ?? false, i = e.cost ?? 0, u = e.edges ?? [], l = o(() => {
      let m = { left: 1, top: 2, right: 4, bottom: 8 };
      return u.map((f) => m[f] || 0).reduce((f, p) => f | p, 0);
    }, "getEdgeMask"), a = l();
    return { id: "tile", tilePosOffset: e.offset ?? S(0), set tilePos(m) {
      let f = this.getLevel();
  ...
  function Ks(e, n) {
    ...
    let r = bt([Nt(n.pos ?? S(0))]), i = e.length, u = 0, l = null, a = null, m = null, f = null, p = o((y) => y.x + y.y * u, "tile2Hash"), x = o((y) => S(Math.floor(y % u), Math.floor(y / u)), "hash2Tile"), D = o(() => {
      l = [];
      ...
      for (me.set(G, 0); Y.length !== 0; ) {
        let Le = (_a = Y.remove()) == null ? void 0 : _a.node;
        if (Le === N)
          break;
        let An = F(Le, P.allowDiagonals);
        for (let Ke of An) {
          let On = (me.get(Le) || 0) + _(Le, Ke) + H(Ke, N);
          (!me.has(Ke) || On < me.get(Ke)) && (me.set(Ke, On), Y.insert({ cost: On, node: Ke }), oe.set(Ke, Le));
        }
      }
      let Tn = [], vt = N, di = x(vt);
      for (Tn.push(di); vt !== G; ) {
  ...
  o(Js, "destroy");
  let bt = T.root.add.bind(T.root), Qs = T.root.readd.bind(T.root), Zs = T.root.removeAll.bind(T.root), ar = T.root.get.bind(T.root);
  function ur(e = 2, n = 1) {
    let r = 0;
  ...
  function ni(e, n = {}) {
    let r = bt([Nt(e), rr()]), i = (n.speed || 1) * 5, u = n.scale || 1;
  ...
  o(ri, "checkFrame");
  function si() {
    let e = T.cam, n = v.fromAngle(xt(0, 360)).scale(e.shake);
    e.shake = Me(e.shake, 0, 5 * Te()), e.transform = new J().translate(_t()).scale(e.scale).rotate(e.angle).translate((e.pos ?? _t()).scale(-1).add(n)), T.root.draw(), fe();
  }
  o(si, "drawFrame");
  function ii() {
    let e = Fe();
...
`));
    ...
    se.paused && Ve(() => {
      ...
      for (let r = 0; r < 2; r++) {
        ...
        qn({ p1: S(-n.width - e * (i ? 2 : 3.5), -e), p2: S(-n.width - e * (i ? 2 : 3.5), -e - n.height), p3: S(-n.width - e * (i ? 3.5 : 2), -e - n.height / 2), pos: S(-r * e * 1 + (i ? -e * 0.5 : 0), 0), color: W(255, 255, 255), fixed: true });
      }
      ze(n), V();
    }), se.curRecording && Ve(() => {
      re(), b(0, ye()), b(24, -24), Qe({ radius: 12, color: W(255, 0, 0), opacity: Mn(0, 1, U.time() * 4), fixed: true }), V();
...
`), font: Qt, pos: S(e, -e), anchor: "botleft", size: 16, width: we() * 0.6, lineSpacing: e / 2, fixed: true, styles: { time: { color: W(127, 127, 127) }, info: { color: W(255, 255, 255) }, error: { color: W(255, 0, 127) } } });
  ...
  function Sn(e) {
    U.run(() => {
      Ve(() => {
        ...
        let a = $e({ ...l, text: e.name, pos: S(32), color: W(255, 128, 0), fixed: true });
        ze(a), Wn({ ...l, text: e.message, pos: S(32, 32 + a.height + 16), fixed: true }), V(), T.events.trigger("error", e);
      });
    });
  }
  o(Sn, "handleErr");
  ...
  let qt = true;
  U.run(() => {
    Ft(), B.loaded || Fe() === 1 && !qt && (B.loaded = true, T.events.trigger("load")), !B.loaded && s.loadingScreen !== false || qt ? ii() : (se.paused || cr(), ri(), si(), s.debug !== false && oi()), qt && (qt = false), Bt(), T.events.trigger("frameEnd");
  });
  function hr() {
